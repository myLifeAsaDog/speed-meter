...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "svelte-22bcw6");
    			add_location(span, file$1, 119, 27, 2926);
    		},
    ...
    // (118:8) {#each Array(scales + 1) as _,i }
    function create_each_block(ctx) {
    	let li;
    	let t;
    	let if_block = /*i*/ ctx[12] % 3 === 0 && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li, "class", "svelte-22bcw6");
    			add_location(li, file$1, 118, 8, 2868);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(118:8) {#each Array(scales + 1) as _,i }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			input = element("input");
    			attr_dev(ol, "class", "svelte-22bcw6");
    			add_location(ol, file$1, 116, 6, 2811);
    			attr_dev(aside, "class", "needle svelte-22bcw6");
    			add_location(aside, file$1, 123, 6, 3005);
    			attr_dev(span, "class", "svelte-22bcw6");
    			add_location(span, file$1, 126, 8, 3110);
    			attr_dev(p, "class", "value svelte-22bcw6");
    			add_location(p, file$1, 124, 6, 3043);
    			attr_dev(div0, "class", "outline svelte-22bcw6");
    			add_location(div0, file$1, 115, 4, 2782);
    			attr_dev(div1, "class", "speedMeter svelte-22bcw6");
    			add_location(div1, file$1, 114, 2, 2752);
    			attr_dev(div2, "class", "speedMeterWrapper svelte-22bcw6");
    			attr_dev(div2, "style", /*cssVarStyles*/ ctx[2]);
    			add_location(div2, file$1, 113, 0, 2694);
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "0");
    			attr_dev(input, "max", "100");
    			add_location(input, file$1, 131, 0, 3226);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 22, 0, 349);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
